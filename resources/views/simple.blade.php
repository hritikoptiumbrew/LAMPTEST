...
<head>
    ...
    <title>ob_testimonial</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                                ...
                                <table>
                                    <tr>
                                        <td valign="top" style="text-align: center; padding: 30px 0 10px 0;"
                                            bgcolor="#ffffff">
                                            <h1 style="text-transform: uppercase; margin: 0; font-family: 'Montserrat', sans-serif; font-size: 24px; line-height: 36px; color: #565566; font-weight: bold;">
                                                Hi
                                    ...
                                    <tr>
                                        <td valign="top" bgcolor="#ffffff"
                                            style="text-align: center; padding: 20px 40px 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #757575;">
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffff"
                                            style="font-family: 'Montserrat', sans-serif; text-align: left; padding: 40px 15px 30px 40px; font-size: 13px; color: gray;">
            ...
            <tr>
                <td style="padding: 40px 80px 40px 80px; font-family: sans-serif; font-size: 15px; line-height: 20px;  text-align: center;">
                    <p style="margin: 0; font-weight:bold; color: #757575;">We are here if you need
                        support</p>
                    <p style="font-size: 12px !important; color:#909090; font-weight: 600; font-family: sans-serif;">
                        Email:
